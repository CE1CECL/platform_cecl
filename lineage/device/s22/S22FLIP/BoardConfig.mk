...
DEVICE_PATH := device/s22/S22FLIP
...
TARGET_KERNEL_SOURCE := kernel/s22/S22FLIP
...
BOARD_SUPER_PARTITION_GROUPS := s22_dynamic_partitions
BOARD_S22_DYNAMIC_PARTITIONS_PARTITION_LIST := \
    product \
    vendor \
    system
BOARD_S22_DYNAMIC_PARTITIONS_SIZE := 9122611200 # TODO: Fix hardcoded value
...
include vendor/s22/S22FLIP/BoardConfigVendor.mk
