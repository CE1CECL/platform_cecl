...
#begin 20200814 liujunting modify for bangkok-tf camera 
#bangkok main 8M: gc8034_mipi_raw/s5k4h7_mipi_raw
#bangkok sub 5M: hi556_mipi_raw/gc5035_mipi_raw
CUSTOM_HAL_FLASHLIGHT = constant_flashlight
CUSTOM_HAL_IMGSENSOR = gc8034_mipi_raw hi556_mipi_raw s5k4h7_mipi_raw gc5035_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_IMGSENSOR = gc8034_mipi_raw s5k4h7_mipi_raw
CUSTOM_HAL_MSENSORLIB = akl akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = hi556_mipi_raw gc5035_mipi_raw
#end 20200814 liujunting modify for bangkok-tf camera
...
#begin 20200814 liujunting modify for bangkok-tf camera
CUSTOM_KERNEL_IMGSENSOR = gc8034_mipi_raw hi556_mipi_raw s5k4h7_mipi_raw gc5035_mipi_raw
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc8034_mipi_raw s5k4h7_mipi_raw
...
#begin modify bo_liu
# begin mod by fuhua.wang for task 9033718 on 2020.03.28
MTK_HAC_SUPPORT = yes
JRD_HAC_EXTERNAL_PA_SUPPORT = yes
# end   mod by fuhua.wang for task 9033718 on 2020.03.28
#end modify bo_liu
...
#task 9879239 change by minglei@tcl.com 2020-09-14
...
# hengchang.zhao 10127503 CtsPermission2TestCases
...
#task 10015414 change by huanhuan.ni@tcl.com 2020-10-19
...
# hengchang.zhao 10107942 vts_treble_vintf_vendor_test
...
MTK_RCS_SUPPORT = no
#modified by hongtailei 20210422 defect 11024377
...
#Added by fujun.yang for Task 9890501 on 2020-09-09 begin
MTK_WMA_PLAYBACK_SUPPORT = no
MTK_WMV_PLAYBACK_SUPPORT = no
#Added by fujun.yang for Task 9890501 on 2020-09-09 end
...
#added by kechun.li@tcl.com for Task 10000731 begin
...
#added by kechun.li@tcl.com for Task 10000731 end
...
#/*RTT Feature config:[Task: 9893188]---start*/
MTK_RTT_SUPPORT = yes
#/*RTT Feature config:[Task: 9893188]---end*/
...
#Defect-10107883 modify shangpeng.su@tcl.com 2020.10.24
...
MTK_ESS_SUPPORT = yes
#Task-10031174 add shangpeng.su@tcl.com 2020.10.10
MTK_WFD_SUPPORT = no
#ADD-BEGIN by bo_liu, BUG-10089773
TCT_BANGKOK_TF = yes
#ADD-END by bo_liu, BUG-10089773
...
TCT_BIGMEMORY_SUPPORT = yes
# [TCTOPTIMIZE] @}

# [TCT-ROM] begin add by junye.li for ROM4.0 task 9528484 on 20200620
-include device/tct/bangkok_NA_OM/tct_vnd_target.mk
-include $(TCTROM_DECOUPLING_ROOT)/build/joyui-build_vnd_system_config.mk
# [TCT-ROM] end add by junye.li for ROM4.0 task 9528484 on 20200620
